...
let song0 = {
    ...
    length: 2.30,
    image: "https://www.whosampled.com/static/track_images_200/lr255718_20191231_234249163924.jpg"
};
...
let song1 = {
    ...
    length: 1.13,
    image: "https://images.genius.com/9761748a04f7f7a8f4342e5c40cb0e77.640x640x1.jpg"
};
...
let song2 = {
    ...
    length: 1.39,
    image: "https://is4-ssl.mzstatic.com/image/thumb/Music114/v4/8a/54/54/8a545494-dae0-509e-e069-dd259d668f8e/4018939324124_1448.jpg/400x400cc.jpg"
};
...
let song3 = {
    ...
    length: 1.42,
    image: "https://open.spotify.com/track/2czm98EWdtLqvyVtp1tmhC?si=22a45a5f7d5e4d02"
};
...
function displaySongInfo() {
  playlist.forEach(function(song){
    ...
    $(".lengths").append(`<p>${song.lengths}</p>`);
    $(".links").append(`<a href=${song.links}>Listen</a>`);
  });
}
